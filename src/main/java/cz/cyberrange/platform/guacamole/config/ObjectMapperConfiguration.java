...
/**
 * Configuration of Object Mapper. Serializing objects to JSON with indent output, serialize dates
 * to one field and use SNAKE_CASE notation instead of camelCase for JSON.
 */
@Configuration
