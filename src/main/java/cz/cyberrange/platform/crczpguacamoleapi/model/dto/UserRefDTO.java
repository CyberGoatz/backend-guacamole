...
@Schema(
        name = "UserRefDTO",
        description = "User information from user-and-group microservice is mapped to this class and is also used to provide information about authors, participants, and organizers."
)
